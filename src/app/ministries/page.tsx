  ...
  return (
    <main className="bg-white min-h-screen font-sans">
      ...
      <section className="py-16 px-4 bg-white text-center">
        ...
        <a href="/contact" className="inline-block bg-yellow-400 text-blue-900 font-bold px-8 py-3 rounded-full shadow-lg hover:bg-blue-900 hover:text-yellow-400 transition-all text-lg">Contact Us to Join a Ministry</a>
      </section>
    </main>
  );
} 